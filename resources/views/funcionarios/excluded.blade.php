<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('dashboard.admin-setor') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900">
                Voltar
            </a>
        </div>
    </x-slot>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">Excluido em</th>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    @foreach ($funcionarios as $funcionario)
                                        <tr>
                                            <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $funcionario->name }}</td>
                                            ...
                                            <td class="px-4 py-3 text-sm text-gray-600">{{ $funcionario->deleted_at?->format('d/m/Y H:i') }}</td>
