...
class SolicitacaoTransferRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($funcionario && (int) $this->input('setor_destino_id') === $funcionario->setor_id) {
                $validator->errors()->add('setor_destino_id', 'Escolha um setor diferente do setor atual.');
            }
            ...
            if ($funcionario && Solicitacao::query()
                ...
                ->exists()) {
                $validator->errors()->add('funcionario_id', 'Este funcionario ja possui uma transferencia pendente.');
            }
        });
    }
}
